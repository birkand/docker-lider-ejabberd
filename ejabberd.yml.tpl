...
##
hosts:
  - "{{ env['XMPP_DOMAIN'] or "example.com" }}"
...
##
## LDAP manager:
ldap_rootdn: "{{ env['LDAP_ROOT_DN'] or "cn=admin,dc=example,dc=com"}}"
##
## Password of LDAP manager:
ldap_password: "{{ env['LDAP_ROOT_PWD'] or "toor"}}"
##
## Search base of LDAP directory:
ldap_base: "{{ env['LDAP_BASE_DN'] or "dc=example,dc=com"}}"
##
...
acl:
  ...
  admin:
    user:
      - "admin": "{{ env['XMPP_DOMAIN'] or "example.com" }}"
  ##     - "ermine": "example.org"
  ##
  ## Blocked users
  ##
